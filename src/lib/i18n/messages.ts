...
export const es = {
  ...
  "categories.summary": "{count} categorías",
  "categories.summaryOne": "1 categoría",
  "categories.empty": "Todavía no tienes ninguna categoría.",
  "categories.deleteConfirm": "¿Eliminar?",
  "categories.editOne": "Editar {name}",
  "categories.deleteOne": "Eliminar {name}",
  "errors.updateCategoryFailed": "No se ha podido guardar la categoría.",
...
export const en: Record<MessageKey, string> = {
  ...
  "categories.summary": "{count} categories",
  "categories.summaryOne": "1 category",
  "categories.empty": "You have no categories yet.",
  "categories.deleteConfirm": "Delete?",
  "categories.editOne": "Edit {name}",
  "categories.deleteOne": "Delete {name}",
  "errors.updateCategoryFailed": "Could not save the category.",
